...
# Set the test server address.
t = Test(address="192.168.1.1", tsig=False, stress=False)

# Local Bind, requires a control port specification, disabled process control.
bind = t.server("bind", address="192.168.1.1", port="53", ctlport="953", external=True)
# Remote Knot, disabled process control.
knot = t.server("knot", address="192.168.1.2", port="53", external=True)
zone = t.zone("flags.")
